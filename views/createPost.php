...
<body class="bg-gray-100 font-sans text-gray-800 pb-24">
    ...
    <header class="bg-amber-600 text-white p-4 fixed m-auto w-full shadow-md z-20 top-0">
        <div class="container mx-auto flex justify-between items-center">
            <h1 class="text-2xl font-bold text-white"><a href="?c=GrowTogether&m=grow" class="mr-2">Create Post</a></h1>
        ...
        <div class="container mx-auto max-w-lg">
            <div class="p-6 bg-white shadow-lg rounded-lg">
                <div class="flex items-center mb-6">
                    ...
                    <h5 class="text-lg font-semibold ml-4"><?= htmlspecialchars($user['user_name'] ?? 'Speaker') ?></h5>
                </div>

                <form action="?c=GrowTogether&m=store" method="POST" enctype="multipart/form-data" class="space-y-6">
                    <div>
