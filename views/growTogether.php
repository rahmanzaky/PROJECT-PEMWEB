...
<body class="bg-gray-100 font-sans text-gray-800">
    ...
    <header class="bg-amber-600 text-white p-4 fixed m-auto w-full shadow-md z-20">
        <div class="container mx-auto flex justify-between items-center">
            <h1 class="text-2xl font-bold text-white">
                <a href="?c=GrowTogether&m=grow" class="hover:text-white">GrowTogether</a>
            </h1>
    ...
    <main class="event-list py-8 px-4 mb-2 pt-24">
        <form action="?c=GrowTogether&m=search" method="POST" class="flex w-full mb-6">
            ...
            <?php else: ?>
                <?php foreach ($events as $event): ?>
                    <div class="event-card bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <a href="?c=GrowTogether&m=showEvent&id=<?= $event['id'] ?>">
                        ...
                        <div class="event-actions flex justify-between items-center">
                            <a href="?c=GrowTogether&m=showReviewForm&event_id=<?= $event['id'] ?>" class="event-rating text-yellow-500 text-3xl hover:text-yellow-400">★</a>
                            <?php
                            ...
                            <?php else: ?>
                                <a href="?c=GrowTogether&m=joinEvent&id=<?= $event['id'] ?>" class="join-event bg-amber-500 text-white px-4 py-2 rounded-lg transform transition-transform duration-200 hover:scale-110">Join Event</a>
                            <?php endif; ?>
