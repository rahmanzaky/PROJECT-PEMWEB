        ...
        <header class="bg-amber-600 text-black p-4 fixed m-auto w-full shadow-md z-20">
            <div class="container mx-auto flex justify-between items-center">
                <h1 class="text-2xl font-bold text-white">
                    <a href="/views/home.php" class="hover:text-white">GrowLink</a>
                </h1>
        ...
        <main class="pt-20">
            <div class="m-5 bg-white rounded-xl border-4 border-amber-600 p-5 flex justify-between items-center relative overflow-hidden shadow-lg">
                ...
                <div class="relative w-24 h-20 flex-shrink-0 text-xl">
                    <div class="absolute top-2 left-5 text-blue-500">⚙️</div>
                    <div class="absolute top-9 right-2 text-blue-500">⚙️</div>
                    <div class="absolute top-1 right-6 text-purple-500">🧩</div>
                    <div class="absolute top-6 left-1 text-red-500">🧩</div>
                    <div class="absolute bottom-2 left-6 text-amber-500">🧩</div>
                    <div class="absolute top-4 left-12 text-yellow-400">⭐</div>
                    <div class="absolute bottom-4 right-5 text-yellow-400">⭐</div>
                    <div class="absolute bottom-1 right-1 text-gray-400">📄</div>
                    <div class="absolute top-10 left-9 text-green-500">📊</div>
                </div>
            </div>
            ...
            <div class="px-5 pb-8">
                ...
                <a href="/views/templates.php" class="block bg-white rounded-lg border-l-4 border-amber-600 p-5 mb-4 shadow-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
                ...
                <a href="/views/growtogether.php" class="block bg-white rounded-lg border-l-4 border-amber-600 p-5 mb-4 shadow-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
                ...
                <a href="/views/list.php" class="block bg-white rounded-lg border-l-4 border-amber-600 p-5 mb-4 shadow-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
